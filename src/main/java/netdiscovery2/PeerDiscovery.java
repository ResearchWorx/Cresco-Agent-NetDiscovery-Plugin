...
private final ArrayList<InetSocketAddress> broadcastAddresses;
 ...
 * @throws IOException
 */
public PeerDiscovery( int group, int port, ArrayList<String> bcastaddresses ) throws IOException
{
  ...
  for(String address : bcastaddresses)
  {
	  broadcastAddresses.add(new InetSocketAddress( address, port ));
  }
  //broadcastAddresses = new InetSocketAddress( "192.168.1.255", port );
